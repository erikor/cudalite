---
title: "Brief User's Guide to cudalite"
author: "Eric J. Kort"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{User's Guide to cudalite}
...
Assuming those requirements are met, the package can be installed as follows:
...
Now we can compile the kernel and load it to the device:
...
In the future, more useful examples should be provided, ideally relevant to gene expression analysis.
